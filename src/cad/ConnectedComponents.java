...
public class ConnectedComponents
{
	...
	public final static ImagePlus computeLabels(ImagePlus imagePlus, int conn, int bitDepth)
	{
		...
		{
			ImageProcessor labels = computeLabels(imagePlus.getProcessor(),conn, bitDepth);
	...
	private final static int findMax(ImageStack image) 
	{
        ...
        public static void main(String []arge){
           ImagePlus i=new ImagePlus("D:\\Degree Subject Materials\\Final Project\\DICOM Samples\\Binary.bmp");
            ImageProcessor im=computeLabels(i.getProcessor(),4,8);
            FileSaver fs=new FileSaver(i);
         boolean result=fs.saveAsBmp("D:\\Degree Subject Materials\\Final Project\\DICOM Samples\\InitialLungMask.bmp");
        }
